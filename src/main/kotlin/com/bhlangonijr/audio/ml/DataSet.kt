...
/**
 * DataSet class containing a list of FeatureSet with correlate feature names
 */
...
/**
 * Contains the list of feature values and its names (useful when dealing with sparse data)
 */
